...
label day_with_command:
    ...
    show kai angry
    kai "Кто пустил его в кафе!? Охрана, выведите этого безумца, пожалуйста. Неужели никто ничего не может с ним сделать? Изо дня в день он донимает людей в этой районе, но никто так и не может привлечь его к ответственности?"
    
    show karen say
    k "Чего завелся то так? Может, и прав он… Я не много об этом слышала, но все-таки слухов об этом среди руководителей среднего звена много, а потом очень уж все похоже на правду. Приходят наверх большие контракты от правительства. На что - никто сказать не может."
    
    kai "Карэн, ты! Тебе не кажется, что распускать слухи среди подчиненных - не лучшая идея? К тому же такие, которые вполне за какое-то обвинение принять можно."

    show karen angry
    k "А чего ты вдруг так стал беспокоиться об этом? Просто сплетничаю в кругу близких знакомых, разве это так уж плохо?"

    show kai serious   
    kai "Мне кажется, достаточно тебе на сегодня выпивки. Давай я отвезу тебя домой."
