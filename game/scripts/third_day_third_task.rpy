...
label end_second_game:
    ...
    а чтобы работать было чуточку проще, используй готовые игровые движки: Unity, RPGMaker VX, CraftStudio, Quest."
    show karen
    ...
    play sound "music/autobus.mp3" fadein fadein fadeout 3.0 volume 0.1 loop
